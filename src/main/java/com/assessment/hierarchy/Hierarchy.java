...
public interface Hierarchy {
     ...
     * The depth for this node will be {@code depth(index)}.
     * 
     ...
     * The unique ID for this node will be {@code nodeId(index)}.
     * 
     * @param index must be non-negative and less than {@link #size()}
     * @return the depth at the specified index
     */
    int depth(int index);

    /**
     * Returns a string representation of the hierarchy in the format:
     * [nodeId1:depth1, nodeId2:depth2, ...]
     * 
